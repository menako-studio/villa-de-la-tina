...
// Blog categories
const blogCategories = ['Pelatihan', 'Healthy', 'Travel', 'Food', 'Lifestyle', 'Innovate'];
...
const blogPosts = [
  {
    ...
    author: 'Melo Gomes',
    date: '14 Jun, 2024',
    image: '/images/tina-wiryawati-center/blog-1.webp',
    size: 'large' as const
  },
  {
    id: 2,
    ...
    author: 'TWC Team',
    date: '10 Jun, 2024',
    image: '/images/tina-wiryawati-center/blog-2.webp',
    size: 'small' as const
  },
  {
    id: 3,
    ...
    author: 'TWC Team',
    date: '5 Jun, 2024',
    image: '/images/tina-wiryawati-center/blog-3.webp',
    size: 'medium' as const
  },
  {
    id: 4,
    title: 'Gathering Komunitas: Membangun Jaringan Kolaborasi',
    category: 'Lifestyle',
    author: 'TWC Team',
    date: '1 Jun, 2024',
    image: '/images/tina-wiryawati-center/blog-4.webp',
    size: 'medium' as const
  },
  {
    id: 5,
    title: 'Pelatihan Olahan Pangan Sehat dan Berkelanjutan',
    category: 'Food',
    author: 'TWC Team',
    date: '28 May, 2024',
    image: '/images/tina-wiryawati-center/blog-5.webp',
    size: 'medium' as const
  }
];

// Gallery moments data
            ...
            <div className="flex flex-col items-start w-full gap-6 md:flex-col lg:flex-row lg:gap-4">
              ...
              <div className="flex flex-col w-full lg:w-[336px] gap-6 p-4 overflow-hidden bg-white shadow-sm rounded-xl">
                <div className="h-[250px] overflow-hidden relative rounded-lg w-full">
                  <Image
                    src="/images/tina-wiryawati-center/program-twc.webp"
                    alt="Pelatihan UMKM"
                    fill
                    className="object-cover"
                  />
                ...
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="flex flex-col gap-2.5 h-full justify-end overflow-hidden relative w-[320px] md:w-[350px] lg:w-[400px] shrink-0">
                    <div className="absolute top-0 left-0 w-full h-full">
                      <Image
                        src={`/images/tina-wiryawati-center/moment-${item}.webp`}
                        alt={`Activity ${item}`}
                        fill
                        className="object-cover"
                      />
