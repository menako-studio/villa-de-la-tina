      ...
      <section className="relative w-full bg-[#a8382d] overflow-hidden">
        <div className="bg-[#f9f6f1] pt-10 md:pt-10 lg:pt-20">
          ...
          <div className="px-6 mb-10 md:px-10 lg:px-20">
            <h2 className="font-['Young_Serif'] font-semibold text-[28px] leading-[33.6px] md:text-[36px] md:leading-[43.2px] lg:text-[40px] lg:leading-[48px] tracking-[-1px] text-[#222] mb-10">
              {content.title.split('\n').map((line, i) => (
    ...
    <>
      ...
      <section className="hidden md:flex w-full bg-[#f9f6f1]">
        ...
        <div className="flex flex-col justify-start w-1/2 p-10 lg:p-20">
          <h2 className="font-['Young_Serif'] font-semibold text-[36px] leading-[43.2px] lg:text-[40px] lg:leading-[48px] tracking-[-1px] text-[#222] mb-10">
            {content.title}
          </h2>
